                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-2">
                                                    <select id="status" name="status" class="form-select form-select-solid">
                                                        ...
                                                        <option value="Y" @if (@Request::get('status')=='Y' ) selected @endif>Active
                                                        </option>
                                                        <option value="N" @if (@Request::get('status')=='N' ) selected @endif>Inactive
                                                        </option>
                                                        <option value="S" @if (@Request::get('status')=='S' ) selected @endif>Suspended
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
