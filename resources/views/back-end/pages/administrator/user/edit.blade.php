												...
												<div class="card-body pt-0">
													<div class="row">
														<div class="col-md-6">
															...
															<input type="text" id="username" name="username" class="form-control mb-2" placeholder="Username" value="{{@$row->username}}">
														</div>
													</div>
	
													<div class="row mb-3">
														<div class="col-md-12">
															<input type="checkbox" id="resetpassword" name="resetpassword"> Change password
														</div>
													</div>
													...
													<div class="row">
														<div class="col-md-6 mb-5">
															...
															<div class="input-group col-mb-6">
																<input type="password" id="password" class="form-control" name="password" placeholder="Password" autocomplete="off" disabled="disabled">
														...
														<div class="col-md-6 mb-5">
															...
															<div class="input-group col-mb-6">
																<input type="password" id="confirm_password" class="form-control" name="confirm_password" placeholder="Confirm password" autocomplete="off" disabled="disabled">
																<div class="input-group-append">                                            
																	<div class="input-group-text">
													...
													<div class="row">
														<div class="col-md-6 mb-5">
															...
															<input type="text" id="profile_name" name="profile_name" class="form-control mb-2" placeholder="Profile name" value="{{$row->profile_name}}">
														</div>
													</div>
												</div>
											</div>
