                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <form method="get">
                                            <div class="row mb-5">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control form-control-solid ps-10" id="keyword" name="keyword" value="<?php echo e(@Request::get('keyword')); ?>" placeholder="Keywords">
                                                </div>
                                                <div class="col-md-2">
                                                    <select id="status" name="status" class="form-select form-select-solid">
                                                        <option value="">All</option>
                                                        <option value="Y" <?php if(@Request::get('status')=='Y' ): ?> selected <?php endif; ?>>Active
                                                        </option>
                                                        <option value="N" <?php if(@Request::get('status')=='N' ): ?> selected <?php endif; ?>>Inactive
                                                        </option>
                                                        <option value="S" <?php if(@Request::get('status')=='S' ): ?> selected <?php endif; ?>>Suspended
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?php echo e(url("$segment/$folder/log_point/$item->id")); ?>"><i class="fa fa-coins fa-2x" style="margin-right:5px;"></i></a>
                                                            <a href="<?php echo e(url("$segment/$folder/edit/$item->id")); ?>"><i class="fa fa-edit fa-2x" style="margin-right:5px;"></i></a>
...
</html><?php /**PATH /home/zpee/domains/pee.orangeworkshop.info/public_html/gfm/resources/views/back-end/pages/setting/customer/index.blade.php ENDPATH**/ ?>